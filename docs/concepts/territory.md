...
expiring (`src/state/territory.ts:174-181`, `src/state/machine.ts:315-331`,
...
rather than blocking (`src/cli/main.ts:187-193`). The Claude Code hook
...
(`src/state/machine.ts:297-312`, `DEFAULTS.ORPHAN_GRACE_MS` at
